...
export default (props, events, { branch, configs }) => {
...
const UserSettingForm = ({ Component, name, available, options, ...props }, events, { settings, branch }) => {
  const modSettings = settings[branch]
