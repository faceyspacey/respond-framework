...
// export default (snap, state) => {
//   if (state[isModule]) return moduleHandler(state, getOpd(getProto(snap)))
//   else if (state.__type) return modelHandler(state, getOpd(getProto(snap)))
...
// const moduleHandler = (state, protoDescriptors) => ({
//   ownKeys(snap) {
//     recordUsage(state.affected, ownKeys, snap)
//     return Reflect.ownKeys(snap)
//   },
...
// const modelHandler = (state, protoDescriptors) => ({
//   ownKeys(snap) {
//     recordUsage(state.affected, ownKeys, snap)
//     return Reflect.ownKeys(snap)
//   },
...
// const getProto = Object.getPrototypeOf
// const getOpd = Object.getOwnPropertyDescriptors
